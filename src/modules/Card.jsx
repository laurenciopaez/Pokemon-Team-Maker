...
const CardPokemon = ({
  ...
  return (
    <>
      <div className="col-4">
        <Card
          style={{ height: "27vh", margin: "auto", width: "20vw" }}
        ...
        >
          ...
          >
            ...
            {/* SI LO PUSISTE EN FAVORITOS, QUE APAREZCA UNA POKEBOLA AL LADO DE LA IMAGEN */}
          </div>{" "}
          {/* AGREGAR BOTON POKEDEX */}
